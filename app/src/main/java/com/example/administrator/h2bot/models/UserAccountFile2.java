...
public class UserAccountFile2 {
    private String user_getUID;
    private String user_email_address;
    private String user_password;
    private String user_status;

    public UserAccountFile2(String user_getUID, String user_email_address, String user_password,  String user_status)
    {
